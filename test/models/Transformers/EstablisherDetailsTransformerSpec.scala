      ...
      s"has nino details in establishers array" in {
        forAll(individualJsValueGen(isEstablisher = true)) {
          individualDetails => {
            ...
            val noNinoResult = noNinoJs.transform(transformer.userAnswersNinoReads("establisherNino", desEstablisherIndividualPath)).get
      ...
      s"has utr details in establishers array" in {
        forAll(individualJsValueGen(isEstablisher = true)) {
          individualDetails => {
            ...
            val noUtrJsResult = noUtrJs.transform(transformer.userAnswersUtrReads("uniqueTaxReference", desEstablisherIndividualPath)).get
