...
import models.{Samples, ToggleDetails}
...
class ToggleDataRepositorySpec extends AnyWordSpec with MockitoSugar with Matchers with Samples with BeforeAndAfter with
  ...
  override def beforeAll(): Unit = {
    when(mockAppConfig.get[String](path = "mongodb.pensions-scheme-cache.toggle-data.name")).thenReturn("toggle-data")
